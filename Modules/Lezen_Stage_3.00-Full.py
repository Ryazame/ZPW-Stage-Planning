...
CorrectieFile = '{0}Stage-Goedkeuring-{1}.xlsx'.format(RootDrive,Year)
...
try:
    with open("""C:\\ZPW\\Stage\\Modules\\JSON\\CorrectDict.JSON""") as json_file:
...
try:
    with open("""C:\\ZPW\\Stage\\Modules\\JSON\\ReplaceDict.JSON""") as json_file:
